  ...
  <!-- script -->
    ...
    <script>
        ...
        function delete_symptoms(symptoms_id){
            ...
            var url = '<?= base_url('admin/delete_symptoms') ?>'
            // console.log(userId);        
            Swal.fire({
                title: 'Are you sure?',
                text: "Symptom will be deleted!",
                icon: 'warning',
